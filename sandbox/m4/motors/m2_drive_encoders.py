...
Authors: David Fisher and Zenwei, Robert, Wes.
...
def main():
    ...
    while time_s != 0:
        ...
        left_motor.run_to_rel_pos(position_sp=dist*90, speed_sp=sp)
        right_motor.run_to_rel_pos(position_sp=dist*90, speed_sp=sp)
        left_motor.wait_while(ev3.Motor.STAT_RUNNING)
        right_motor.wait_while(ev3.Motor.STAT_RUNNING)
        ev3.Sound.beep().wait()
    print("Goodbye!")
