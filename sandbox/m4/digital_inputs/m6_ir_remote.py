...
Authors: David Fisher and Wes, Zei, Bobby.
...
def main():
    ...
    rc1.on_red_up = lambda button_state: handle_left_motor_forward(button_state, robot)
    rc1.on_red_down = lambda button_state: handle_left_motor_backward(button_state, robot)
    rc1.on_blue_up = lambda button_state: handle_right_motor_forward(button_state, robot)
    rc1.on_blue_down = lambda button_state: handle_right_motor_backward(button_state, robot)
